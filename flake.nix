      ...
      packages = forAllSystems (pkgs:
        {
          ...
          foolfad-fly = pkgs.callPackage ./packages/foolfad-fly { };
          foolfad-ssh = pkgs.callPackage ./packages/foolfad-ssh { };
          foolfad-tailscale = pkgs.callPackage ./packages/foolfad-tailscale { };
